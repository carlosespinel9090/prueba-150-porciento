...
(function ($, Drupal) {
  ...
  var btnMenu = function btnMenu() {
    var button = document.querySelector('#block-buttonmenu');
    var navbarMain = document.querySelector('#navbar-main');
    var elementToToggle = document.getElementById('CollapsingNavbar');
  ...
  var btnTimeLine = function btnTimeLine() {
    var boxlength = document.getElementsByClassName('box-time-line');
